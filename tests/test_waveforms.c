			 ...
			 float min_snr_db, int max_offset)
{
	...
	if (th_encode(MUX_CODEC_MP3, SAMPLE_RATE, NUM_CHANNELS, 2, params, 2,
...
int main(void)
{
	...
	if (test_waveform("C Major Chord", sig, 0.0f, 1024) != 0) failed++;
